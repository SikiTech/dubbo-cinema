 ...
 */
package com.sikiapp.cinema.core.util;

import com.sikiapp.cinema.core.support.StrKit;
...
public class ToolUtil {
    ...
    public static String dateType(Object o) {
        if (o instanceof Date) {
            return com.sikiapp.cinema.core.util.DateUtil.getDay((Date) o);
        } else {
            return o.toString();
        }
    }
...
//	}
    ...
    public static String currentTime() {
        return com.sikiapp.cinema.core.util.DateUtil.getTime();
    }
